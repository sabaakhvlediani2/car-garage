...
- მანქანის დამატება, რედაქტირება და წაშლა, ვალიდაციითურთ.
- დეტალების გვერდი თითოეულ მანქანაზე.
- სტატისტიკის გვერდი დიაგრამებით.

## დიაგრამები

დიაგრამები ხელით დავხატეთ Compose-ის Canvas-ზე, არანაირი მზა ბიბლიოთეკა არ გამოგვიყენებია:
...
ორივემ ცალ-ცალკე commit-ები გავაკეთეთ.
