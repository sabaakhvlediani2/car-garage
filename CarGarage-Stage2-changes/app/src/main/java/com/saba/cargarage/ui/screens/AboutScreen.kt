...
fun AboutScreen(onOpenDrawer: () -> Unit) {
    Scaffold(
        ...
        Column(
            ...
            FeatureCard(Icons.Filled.QueryStats, "Statistics", "Custom-drawn charts summarise the inventory.")
            ...
            Card(
                ...
                Column(Modifier.padding(16.dp)) {
                    ...
                    Text("• Lasha Khutsishvili — statistics & charts", style = MaterialTheme.typography.bodyLarge)
                }
            }
